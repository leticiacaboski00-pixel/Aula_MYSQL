...
-- ============================================================
-- 1. ESTRUTURA DO BANCO DE DADOS E DADOS DE TESTE
-- ============================================================
...
SELECT 
    c.id_cliente,
    c.nome_cliente,
    COALESCE(SUM(v.valor_total), 0.00) AS total_comprado
FROM clientes c
LEFT JOIN vendas v ON c.id_cliente = v.id_cliente
GROUP BY c.id_cliente, c.nome_cliente;
...
SELECT 
    ...
    c.cidade,
    COUNT(v.id_venda) AS quantidade_vendas,
    COALESCE(SUM(v.valor_total), 0.00) AS valor_total_comprado,
